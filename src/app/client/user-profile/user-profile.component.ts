...
export class UserProfileComponent implements OnInit {
  ...
  setImg(event: any){
    ...
    if(this.selectedFiles){
      ...
      if(file){
        ...
        this.imageService.uploadForUser(this.username, this.currentFile).subscribe({
          next: res =>{
  ...
  updateProfile(){
    const{firstname,lastname,email,country,address,phone} = this.updateForm;
    this.userService.updateProfile(this.username,firstname,lastname,email,country,address,phone).subscribe({
      next: res =>{
        this.getUser();
